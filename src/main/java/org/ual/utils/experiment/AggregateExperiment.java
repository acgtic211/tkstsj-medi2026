...
public class AggregateExperiment implements IExperimentConfiguration {
    ...
    public void setAggregateFunctions(List<String> aggregateFunctions) { this.aggregateFunctions = aggregateFunctions; }
    @Override
